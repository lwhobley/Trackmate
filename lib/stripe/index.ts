...
export async function createCheckoutSession({
  ...
  entryFeePerAthlete, entryFeePerTeam, meetName, successUrl, cancelUrl,
}: {
  meetId: string; teamId: string; orgId: string; athleteCount: number
  entryFeePerAthlete: number; entryFeePerTeam: number; meetName: string
  ...
  return stripe.checkout.sessions.create({
    ...
    metadata: { meet_id: meetId, team_id: teamId, org_id: orgId, athlete_count: athleteCount.toString() },
  })
}
